...
Next.js 16 (App Router) + Supabase. Entorno de desarrollo local igual al de
Workset: app en `localhost`, Supabase en Docker, Mailpit para mails.

Para levantarlo con datos de demostración —que es lo que conviene si lo único
que querés es ver el sistema funcionando— está [`demo.md`](demo.md).
